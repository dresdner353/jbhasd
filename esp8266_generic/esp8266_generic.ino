...
// and sensor register into a single structure
...
//    Name            Boot Pin  WiFI LED Pin  Switch Register                      Sensor Register
    { "Sonoff Basic", 0,        13,           &gv_switch_register_sonoff_basic[0], &gv_sensor_register_sonoff_basic[0] },
    { "Sonoff S20",   0,        13,           &gv_switch_register_sonoff_s20[0],   &gv_sensor_register_sonoff_s20[0] },
    { "ESP-01",       0,        1,            &gv_switch_register_esp01[0],        &gv_sensor_register_esp01[0] },
    { NULL,           0,        0,            NULL,                                NULL }  // terminator.. never delete
};
...
void apply_config_profile(char *profile)
{
    ...
    log_message("apply_config_profile(%s)\n", profile);
    ...
    if (gv_profile_register[i].name != NULL) {
        log_message("located and applied profile\n");
